...
if stdout_output:
    ...
    try:
        real_name = stderr_output.split(" ")[1].replace(":", "").strip()
        print("[DEBUG] real_name from stderr:", real_name)
    except Exception as e:
...
def check_param_run(ALL_ERROR):
    ...
    if len(sys.argv) >= 2:
            ...
            for i_script_args in script_args:
                ...
                if not os.path.exists(f"/app/airflow/{i_script_args}"):
                    ...
                    with open("/app/airflow_deploy/log/deploy.log", "a") as file_log:
                        ...
                        file_log.write(
                            f"{current_datetime_now} {real_name} Нету такого файла или директории /app/airflow/{i_script_args}\n\n"
                        )
            ...
            if configuration == "one-way":
                ...
                for i_script_args in script_args:
                    ...
                    if os.path.isfile(f"/app/airflow/{i_script_args}"):
                        ...
                        with open(
                            "/app/airflow_deploy/log/deploy.log", "a"
                        ) as file_log:

                            file_log.write(
                                f"{current_datetime_now} {real_name} Delete file: /app/airflow/{i_script_args}\n\n"
                            )
                    ...
                    if os.path.isdir(f"/app/airflow/{i_script_args}"):
                        ...
                        with open(
                            ...
                            file_log.write(
                                f"{current_datetime_now} {real_name} Delete directory: /app/airflow/{i_script_args}\n\n"
                            )
                ...
                for i_script_args in script_args:
                    ...
                    for i_all_hosts in all_hosts:
                        ...
                        with open(
                            ...
                            file_log.write(
                                f"{current_datetime_now} {real_name} {i_all_hosts}  Delete file: /app/airflow/{i_script_args}\n\n"
                            )
        ...
        if sys.argv[1] == "--file":
            ...
            for i_script_args in script_args:
                if not os.path.exists(f"/app/airflow_deploy/{i_script_args}"):
                    with open("/app/airflow_deploy/log/deploy.log", "a") as file_log:
                        file_log.write(
                            f"{current_datetime_now} {real_name} Файл не найден /app/airflow_deploy/{i_script_args} !\n\n"
                        )
                    print("1")
                    sys.exit(1)
                        ...
                        if i_script_args.count("/") > 1:
                            ...
                            if "rsync error" in result_command:
                                ...
                                with open(
                                    ...
                                    file_log.write(
                                        f"{current_datetime_now} {real_name} {result_command} \n\n"
                                    )
                            ...
                            with open(
                                ...
                                file_log.write(
                                    f"{current_datetime_now} {real_name} Добавлен файл /app/airflow/{i_script_args} \n\n"
                                )
                        else:
                        ...
                        if i_script_args[:6] == "keytab":
                            ...
                            if i_script_args.count("/") > 1:
                                ...
                                with open(
                                    ...
                                    file_log.write(
                                        f"{current_datetime_now} {real_name} {i_all_hosts} Добавлен файл: /app/airflow/{i_script_args}\n\n"
                                    )
            ...
            for i_script_args in script_args:
                ...
                if not os.path.exists(f"/app/airflow_deploy/{i_script_args}"):
                    ...
                    with open("/app/airflow_deploy/log/deploy.log", "a") as file_log:
                        ...
                        file_log.write(
                            f"{current_datetime_now} {real_name} Директория не найдена /app/airflow_deploy/{i_script_args} \n\n"
                        )
                    ...
                    if i_script_args[:6] == "keytab":
                        if i_script_args.count("/") > 1:
                            ...
                            with open(
                                ...
                                file_log.write(
                                    f"{current_datetime_now} {real_name} Добавлена директория /app/airflow_deploy/{i_script_args}/ \n\n"
                                )
                        ...
                        if i_script_args[:6] == "keytab":
                            ...
                            if i_script_args.count("/") > 1:
                                ...
                                with open(
                                    ...
                                    file_log.write(
                                        f"{current_datetime_now} {real_name} {i_all_hosts} Добавлена директория: /app/airflow/{i_script_args}\n\n"
                                    )
                            else:
                                ...
                                with open(
                                    ...
                                    file_log.write(
                                        f"{current_datetime_now} {real_name} {i_all_hosts} Добавлена : /app/airflow/{i_script_args}\n\n"
                                    )
                            ...
                            if i_script_args.count("/") > 1:
                                ...
                                with open(
                                    ...
                                    file_log.write(
                                        f"{current_datetime_now} {real_name} {i_all_hosts} Добавлена директори: /app/airflow/{i_script_args}\n\n"
                                    )
        ...
        if sys.argv[1] == "-h":
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА: sudo -u airflow_deploy ./airflow_sync_dags_v2.sh\n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА: sudo -u airflow_deploy ./airflow_sync_dags_v2.sh --skipped\n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА: sudo -u airflow_deploy ./airflow_sync_dags_v2.sh -c\n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА: sudo -u airflow_deploy ./airflow_sync_dags_v2.sh -h\n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА (Удаление файла): sudo -u airflow_deploy ./airflow_sync_dags_v2.sh --delete /dags/test.py"
                )
            )

            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА (Удаление директории): sudo -u airflow_deploy ./airflow_sync_dags_v2.sh --delete /dags/test_dir \n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА : sudo -u airflow_deploy ./airflow_sync_dags_v2.sh --file /dags/test.py\n\n"
                )
            )
            ...
            print(
                "\033[32m{}\033[0m".format(
                    "ПРИМЕР ЗАПУСКА : sudo -u airflow_deploy ./airflow_sync_dags_v2.sh --dir /dags/test_dir\n\n"
                )
            )
            ...
            if configuration == "one-way":
                ...
                for elem_list_folders in list_folders:
                    ...
                    for elem_files_and_directories in files_and_directories:
                        ...
                        if (
                            "__pycache__"
                            in f"/app/airflow/{elem_list_folders}/{elem_files_and_directories}"
                        ):
    ...
    if (
        ...
        with open("/app/airflow_deploy/log/deploy.log", "a") as file_log:
            ...
            file_log.write(
                f"{current_datetime_now} {real_name} Неизвестный ключ/и {sys.argv[1:]}\n\n"
            )
        ...
        for elem_list_folders in list_folders:
            ...
            if elem_list_folders == "keytab":
                ...
                result_check_permission = os.popen(
                    f"ssh airflow_deploy@{host} find /app/airflow/keytab ! -group airflow_deploy ! -group airflow"
                )
                ...
                if len(for_result_check_permission) > 1:
                    ...
                    for i_result_check_permission in for_result_check_permission:
                        ...
                        ALL_ERROR.put(
                            f"Ошибка !!! Некорректная группа {host} {perm_error}\n\n"
                        )

            elif elem_list_folders == "keys":

                result_check_permission = os.popen(
                    f"ssh airflow_deploy@{host} find /app/airflow/keys ! -group airflow_deploy ! -group airflow"
                )
                ...
                if len(for_result_check_permission) > 1:
                    ...
                    for i_result_check_permission in for_result_check_permission:
                        ...
                        ALL_ERROR.put(
                            f"Ошибка !!! Некорректная группа на хосту {host}  {perm_error}\n\n"
                        )
                ...
                for i_result_check_permission in for_result_check_permission:
                    ...
                    if len(i_result_check_permission) > 2:
                        ...
                        ALL_ERROR.put(
                            f"Ошибка !!! Некорректный владелец на хосту {host}  {perm_error}\n\n"
                        )
    ...
    if configuration == "one-way":
        ...
        for elem_list_folders in list_folders:
            ...
            if elem_list_folders == "keytab":
                ...
                result_check_permission = os.popen(
                    f"find /app/airflow/keytab ! -group airflow_deploy ! -group airflow"
                )
                ...
                result_check_permission = os.popen(
                    f"find /app/airflow/keys ! -group airflow_deploy ! -group airflow"
                )
    ...
    if configuration == "claster":
        ...
        for elem_list_folders in list_folders:
            ...
            if elem_list_folders == "keytab":
                ...
                result_check_permission = os.popen(
                    f"ssh airflow_deploy@{host} find /app/airflow/keytab -type f ! -perm 0060"
                )
                ...
                if len(for_result_check_permission) > 1:
                    ...
                    for i_result_check_permission in for_result_check_permission:
                        ...
                        ALL_ERROR.put(
                            f"Ошибка !!! Отсутсвует право на запись на хосту {host} в {perm_error}\n\n"
                        )

            elif elem_list_folders == "keys":

                result_check_permission = os.popen(
                    f"ssh airflow_deploy@{host} find /app/airflow/keys -type f ! -perm 0060"
                )
    ...
    if configuration == "one-way":
        ...
        for elem_list_folders in list_folders:
            ...
            if elem_list_folders == "keytab":
                ...
                result_check_permission = os.popen(
                    f"find /app/airflow/keytab -type f ! -perm 0060"
                )
                ...
                result_check_permission = os.popen(
                    f"find /app/airflow/keys -type f ! -perm 0060"
                )
        ...
        for file in files:
            ...
            if temp_file.rpartition(".")[2] not in type_files:
                ...
                if temp_file.startswith("/app/airflow_deploy/dags/sql"):
                    ...
                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .sql)\n\n"
                    )

                if temp_file.startswith(
                    "/app/airflow_deploy/dags"
                ) and not temp_file.startswith("/app/airflow_deploy/dags/sql"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .py)\n\n"
                    )

                elif temp_file.startswith("/app/airflow_deploy/keytab"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .keytab)\n\n"
                    )

                elif temp_file.startswith("/app/airflow_deploy/scripts"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .sh .json)\n\n"
                    )

                elif temp_file.startswith("/app/airflow_deploy/keys"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .pfx .p12 .jks .secret)\n\n"
                    )

                elif temp_file.startswith("/app/airflow_deploy/csv"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .csv)\n\n"
                    )

                elif temp_file.startswith("/app/airflow_deploy/jar"):

                    ALL_ERROR.put(
                        f"Ошибка !!! Недопустимый тип файла {temp_file} для директории {dir_folder} (Допустимое расширение .jar)\n\n"
                    )
...
def check_free_space(data_host, ALL_ERROR):
    ...
    if configuration == "claster":
        ...
        if used_percent > CRITICAL_PERCENT:
            ...
            ALL_ERROR.put(
                f"Предупреждение !!! После добавления файлов на хост {data_host} колличество занятого места превысит 80% в каталоге /app на хосту {data_host}\n\n"
            )
...
def rsync_host(hostname):
    ...
    for list_folder in list_folders:
        ...
        if list_folder == "keytab":
            ...
            result_command = os.popen(
                f"rsync --checksum -rogp --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=,Fg=rw,Fu=,Fo= /app/airflow_deploy/keytab airflow_deploy@{hostname}:/app/airflow/ 2> /dev/null"
            ).read()

        elif list_folder == "keys":

            result_command = os.popen(
                f"rsync --checksum -rogp --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=,Fg=rw,Fu=,Fo= /app/airflow_deploy/keys airflow_deploy@{hostname}:/app/airflow/ 2> /dev/null"
            ).read()

        else:

            result_command = os.popen(
                f"rsync --checksum -rogp --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=rx,Fg=rwx,Fu=rwx,Fo=rx /app/airflow_deploy/{list_folder} airflow_deploy@{hostname}:/app/airflow/ 2> /dev/null"
            ).read()
        ...
        for root, dirs, files in os.walk(f"/app/airflow_deploy/{list_folder}"):
            ...
            for file in files:
                ...
                with open("/app/airflow_deploy/log/deploy.log", "a") as file_log:
                    ...
                    file_log.write(
                        f"  Source: {root}/{file}  Destination: {hostname}@{temp_file_airflow}  Md5hash: {md5_sum}\n\n"
                    )
    ...
    for list_folder in list_folders:
        ...
        if list_folder == "keytab":
            ...
            result_command_keytab = subprocess.Popen(
                f"rsync --checksum -nrogp --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=,Fg=rw,Fu=,Fo= /app/airflow_deploy/keytab airflow_deploy@{hostname}:/app/airflow/",
                shell=True,
            ...
            result_command_keys = subprocess.Popen(
                f"rsync --checksum -nrogp --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=,Fg=rw,Fu=,Fo= /app/airflow_deploy/keys airflow_deploy@{hostname}:/app/airflow/",
                shell=True,
                stdout=subprocess.PIPE,
                stderr=subprocess.PIPE,
            )

            result_command_keys_string = result_command_keys.stderr.read().decode(
                "utf-8"
            )
            ...
            result_command_other = subprocess.Popen(
                f"rsync --checksum -nrogp  --chown=airflow_deploy:airflow --chmod=Du=rwx,Dg=rwx,Do=rx,Fg=rwx,Fu=rwx,Fo=rx /app/airflow_deploy/{list_folder} airflow_deploy@{hostname}:/app/airflow/",
                shell=True,
                stdout=subprocess.PIPE,
                stderr=subprocess.PIPE,
            )
            ...
            if "rsync error" in result_command_other_string:
                ...
                ALL_ERROR.put(
                    f"Ошибка!!! {hostname} {result_command_other_string} \n\n"
                )
